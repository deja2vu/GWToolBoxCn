...
void GameSettings::RegisterSettingsContent() {
    ...
    ToolboxModule::RegisterSettingsContent(u8"仓库设置", ICON_FA_BOXES,
    ...
    ToolboxModule::RegisterSettingsContent(u8"聊天设置", ICON_FA_COMMENTS,
        [this](const std::string* section, bool is_showing) {
            UNREFERENCED_PARAMETER(section);
            if (!is_showing) return;
            DrawChatSettings();
    ...
    ToolboxModule::RegisterSettingsContent(u8"队伍设置", ICON_FA_USERS,
        [this](const std::string* section, bool is_showing) {
            UNREFERENCED_PARAMETER(section);
            if (!is_showing) return;
            DrawPartySettings();
